...
/**
 * 可放大ImageView，替换ImageView即可使用
 */
@SuppressLint("AppCompatCustomView")
public class Camera_ZoomImageView extends ImageView implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    public Camera_ZoomImageView(Context context) {
        this(context, null);
    }

    public Camera_ZoomImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public Camera_ZoomImageView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        gestureDetector = new GestureDetector(context, new GestureDetector.SimpleOnGestureListener() {
            ...
            public boolean onSingleTapConfirmed(MotionEvent e) {
                ...
                if (onClickListener != null)
                    onClickListener.onClick(Camera_ZoomImageView.this);
                return true;
            }
        });
