...
public class Camera_inviting extends AppCompatActivity {
    ...
    public void updateUI(){
        ...
        mFangqiButton = findViewById(R.id.fangqi_button);
        mName = findViewById(R.id.camera_name_text);
        minitiator = findViewById(R.id.camera_initiator_text);
        mTime = findViewById(R.id.camera_time_text);
        mTitle = findViewById(R.id.camera_title_text);
        mTimeofone = findViewById(R.id.camera_timeofone_text);
        mAllUser = findViewById(R.id.camera_alluser_text);
