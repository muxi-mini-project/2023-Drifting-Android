...
public class Drawing_InvitingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Call<inviting_messageReturn> call = request.drawing_request(Login_LoginActivity.getToken());
                    ...
                    if(request_return.getData().get(i).getFile_id() == id){
                        ...
                        idMessageReturnCall.enqueue(new Callback<getIdMessageReturn>() {
                            ...
                            public void onFailure(Call<getIdMessageReturn> call, Throwable t) {
                                Toast.makeText(Drawing_InvitingActivity.this, "获取详细信息失败，请检查网络", Toast.LENGTH_SHORT).show();
                            }
                        });
