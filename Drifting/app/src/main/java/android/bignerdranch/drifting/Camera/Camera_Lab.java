...
public class Camera_Lab {
    private List<Camera_> mDrift_Cameras;
     ...
     * @param title 项目主题
     */
    public void Newdrift_camera(Context context, String name ,String title ,int maxuser) {
        //创建漂流相机项目
       // Camera_ drift_camera = new Camera_(name,title,maxuser);
        //保存在总库中
