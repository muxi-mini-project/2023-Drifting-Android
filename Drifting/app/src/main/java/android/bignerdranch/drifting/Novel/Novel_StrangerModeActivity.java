...
public class Novel_StrangerModeActivity extends AppCompatActivity {
        ...
        start.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (name == null || theme == null || person_number == null || person_number.equals("")) {
                    Toast.makeText(Novel_StrangerModeActivity.this, "请输入名字，主题和人数", Toast.LENGTH_SHORT).show();
                } else {
                    ...
                    call.enqueue(new Callback<create_return>() {
                        ...
                        public void onResponse(Call<create_return> call, Response<create_return> response) {
                            ...
                            if (create_return != null) {
                                ...
                                Toast.makeText(Novel_StrangerModeActivity.this, "创建失败", Toast.LENGTH_SHORT).show();
                            }
                        }
